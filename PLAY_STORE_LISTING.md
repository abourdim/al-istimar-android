# Play Store listing — Al Istimar (الاستعمار أحقاد وأطماع)
...
- **Package name**: `org.workshopdiy.alistimar`
...
```
كتاب "الاستعمار أحقاد وأطماع" تطبيق تفاعلي — للشيخ محمد الغزالي
```

### Full description (≤4000 chars)
```
🏴 الاستعمار أحقاد وأطماع — تطبيق تفاعلي

تطبيق تفاعلي ثلاثي اللغة (عربي/إنجليزي/فرنسي) مستوحى من كتاب "الاستعمار أحقاد وأطماع" للشيخ محمد الغزالي رحمه الله (1917–1996).
...
• كتاب "الاستعمار أحقاد وأطماع" — الشيخ محمد الغزالي
...
### App name
```
Al Istimar — Colonialism: Grudges & Greed
```

### Short description
```
"Colonialism: Grudges & Greed" — interactive trilingual app by Sheikh al-Ghazali
```
...
Interactive trilingual app (Arabic / English / French) based on the book "Colonialism: Grudges & Greed" by Sheikh Mohammed al-Ghazali (1917–1996).
...
• "Colonialism: Grudges & Greed" — Sheikh Mohammed al-Ghazali
...
### App name
```
Al Istimar — Al Istimar
```

### Short description
```
« Colonialism: Grudges & Greed » — application trilingue par Cheikh al-Ghazali
```
...
Application interactive trilingue (arabe / anglais / français) inspirée du livre « Colonialism: Grudges & Greed » du Cheikh Mohammed al-Ghazali (1917–1996).
...
• « Colonialism: Grudges & Greed » — Cheikh Mohammed al-Ghazali
...
```
Privacy Policy — Al Istimar
Last updated: 2026-04-26

The Al Istimar app does not collect, store, transmit, or share any personal
